    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown ">
                ...
                <ul class="dropdown-menu">
                    <li class=""><a class="nav-link" href="{{ route('admin.categories') }}"><i class="fas fa-hand-point-right"></i> <span>Categories</span></a></li>
                    <li class=""><a class="nav-link" href="{{ route('admin.sub-categories') }}"><i class="fas fa-hand-point-right"></i> <span>Sub Categories</span></a></li>
                    {{-- <li class=""><a class="nav-link" href="{{ route('admin.sidebar-ad') }}"><i class="fas fa-angle-right"></i>Sidebar advertisement</a></li> --}}
                </ul>
            </li>
